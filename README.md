Esse projeto é a implementação de APIs para um sistema de academia.


Por meio desse projeto pude aprender mais sobre fundamentos de Java de uma forma prática.


É preciso fazer um controller, uma entity, um repository e um service.


O service faz efetivamente as implementações no banco de dados.


O repository faz consultas no banco de dados pra trazer dados para a aplicação.


A entity faz o instaciamento das entidades aluno, matrícula e avaliação física.


O controller faz o roteamento das páginas com as respectivas APIs.
...
Créditos do projeto para [cami-la](https://www.linkedin.com/in/cami-la/ "cami-la").
